        ...
        <div class="container">
            ...
            <div class="row">
                <?php foreach ($kategori as $key => $value): ?>
                    <div class="col-lg-3 col-md-4 col-sm-6 text-center mb-4 kategori-item">
                        <a href="<?php echo base_url('kategori/detail/'.$value['id_kategori']) ?>" class="text-decoration-none">
                            <img src="<?php echo $this->config->item('url_kategori').$value['foto_kategori'] ?>" class="img-fluid">
    ...
    <div class="container">
        ...
        <div class="row">
            <?php foreach ($artikel as $key => $value): ?>
                <div class="col-lg-4 col-md-4 col-sm-6 text-center mb-4 kategori-item">
