        ...
        <div class="col-md-3">
            <table class="table table-sm">
                ...
                <tr>
                    ...
                    <td><?php echo $cekmidtrans["order_id"] ?></td>
                </tr>
                <tr>
                    <td>Tipe Pembayaran</td>
                ...
                <tr>
                    <td>Kode VA</td>
                    <td><?php echo $cekmidtrans["merchant_id"] ?></td>
                </tr>
                <tr>
...
<script src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="<SB-Mid-client-CZPPu4U_7eeArd0I>"></script>
