...
<div class="container">
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="pengarang" value="<?php echo $produk['pengarang'] ?>" class="form-control">
        </div>
        <div class="mb-3">
            <label>Harga</label>
        ...
        <div class="mb-3">
            <label>Stok</label>
            <input type="number" name="stok" value="<?php echo $produk['stok'] ?>"class="form-control">
        </div>
        <div class="mb-3">
            <label>Foto</label>
