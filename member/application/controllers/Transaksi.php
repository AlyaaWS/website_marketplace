...
class Transaksi extends CI_Controller {
    ...
    function detail($id_transaksi) {
        ...
        \Midtrans\Config::$serverKey = 'SB-Mid-server-BE6Y3OaFFQ7vIHD_LRrLrThW';
        ...
        //cek ke midtrans status transaksinya apa
        $curl = curl_init();
        curl_setopt_array($curl, array(
            ...
            CURLOPT_HTTPHEADER => array(
                "accept: application/json","authorization: Basic U0ItTWlkLXNlcnZlci1CRTZZM09hRkZRN3ZJSERfTFJyTHJUaFc6YW1pa29t"
            ),
        ));
